...
const FEATURES = [
  ...
  { icon: Package, title: 'Sistema de Mods', desc: 'Más de 140 mods cuidadosamente seleccionados para ofrecer una experiencia equilibrada y épica sin sacrificar el rendimiento.', color: '#f0b429' },
    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
        ...
        <div ref={heroRef} className="reveal text-center max-w-4xl mx-auto z-10 pt-20">
            ...
            <div className="inline-block relative mb-4">
              <div className="w-72 h-72 sm:w-96 sm:h-96 mx-auto rounded-[3rem] overflow-hidden border border-violet-500/40 flex items-center justify-center relative"
                style={{
                  ...
                  boxShadow: '0 0 80px rgba(147, 51, 234, 0.45), 0 0 160px rgba(147, 51, 234, 0.18)',
                }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
            ...
            <Link to="/modpack" className="btn-outline px-8 py-4 text-base rounded-2xl">
              <Package size={16} />
              <span>Modpack</span>
            </Link>
            <Link to="/rangos" className="btn-gold px-8 py-4 text-base rounded-2xl">
              <Trophy size={16} />
              <span>Rangos</span>
            </Link>
          </div>
      ...
      <section className="py-16 px-4 relative">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard value="150+" label="Jugadores" icon={Users} />
          <StatCard value="140+" label="Mods instalados" icon={Package} />
