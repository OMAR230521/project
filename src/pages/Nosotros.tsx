...
function TeamCard({ member }: { member: typeof TEAM[0] }) {
  ...
  return (
    <div ref={ref} className="reveal glass rounded-2xl p-5 text-center glass-hover">
      ...
      <p className="text-xs text-violet-400 mt-0.5 mb-2">{member.role}</p>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div ref={heroRef} className="reveal text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Somos un equipo apasionado por Minecraft y la creación de experiencias únicas. BolaLand nació con la visión de crear el mejor servidor de mods hispanohablante del mundo.
          </p>
        </div>
        ...
        <section className="mb-20">
          <div ref={storyRef} className="reveal relative rounded-3xl p-8 sm:p-10 overflow-hidden"
            style={{
              background: 'linear-gradient(135deg, rgba(15, 10, 35, 0.9) 0%, rgba(25, 15, 50, 0.9) 100%)',
              border: '1px solid rgba(179, 71, 255, 0.2)',
            }}>
            <div className="absolute inset-0 pointer-events-none"
              style={{ background: 'radial-gradient(ellipse at 0% 50%, rgba(147, 51, 234, 0.1) 0%, transparent 60%)' }} />
              ...
              <div className="grid grid-cols-2 gap-3">
                {STORY_STATS.map(s => (
                  <div key={s.label} className="glass rounded-xl p-4 text-center">
                    <p className="font-orbitron font-bold text-2xl" style={{ color: '#c96bff' }}>{s.value}</p>
        ...
        <div ref={missionRef} className="reveal relative rounded-3xl p-8 text-center overflow-hidden"
          style={{
            background: 'linear-gradient(135deg, rgba(15, 10, 35, 0.95) 0%, rgba(10, 8, 25, 0.95) 100%)',
            border: '1px solid rgba(179, 71, 255, 0.25)',
            boxShadow: '0 20px 60px rgba(0,0,0,0.4)',
          }}>
          <div className="absolute inset-0 pointer-events-none"
            style={{ background: 'radial-gradient(ellipse at 50% 100%, rgba(147, 51, 234, 0.12) 0%, transparent 60%)' }} />
          <Target size={36} className="mx-auto mb-3 text-violet-400 relative z-10" />
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-sm leading-relaxed relative z-10">
            Crear la experiencia definitiva de Minecraft con mods para la comunidad hispanohablante. Un lugar donde cada jugador, sin importar su nivel, pueda encontrar su aventura, conectar con otros y vivir momentos épicos que recuerden para siempre.
          </p>
