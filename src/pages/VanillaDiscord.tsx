...
const CHANNELS = [
  { icon: MessageCircle, name: '#general', desc: 'Chat principal de la comunidad', color: '#22c55e' },
...
export default function VanillaDiscord() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={heroRef} className="reveal text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-lg mx-auto mb-8">
            Nuestra comunidad te espera. Conecta con jugadores Hispanohablantes, recibe soporte y entérate de eventos exclusivos.
          </p>
        ...
        <div ref={ctaRef} className="reveal relative rounded-3xl p-8 text-center"
          style={{
            background: 'linear-gradient(135deg, rgba(34, 197, 94, 0.12) 0%, rgba(22, 163, 74, 0.1) 100%)',
